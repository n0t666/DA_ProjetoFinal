...
namespace DA_ProjetoFinal.Controllers
{
    ...
    internal class PratoController
    {
        ...
        public static bool AdicionarPrato(string descricao,TipoPrato tipo,bool activo)
        {
            try 
            {
        ...
        public static List<Prato> PaginacaoPratos(int paginaAtual,int paginaTamanho)
        {
            using (var context = new CantinaContext())
            {
        ...
        public static List<TipoPrato> ObterTiposPrato()
        {
        ...
        public static bool ApagarPrato(int id)
        {
            try
            {
                using (var context = new CantinaContext())
        ...
        public static bool EditarPrato(int id, string descricao, TipoPrato tipo, bool activo)
        {
            try
            {
                using (var context = new CantinaContext())
